...
<body>
	<div class="wrap">
		...
		<div id="content-wrapper">
			<h4>회원정보 수정</h4>
			<form class="find" action="update_user.do" method="get">
				<input type="text" id="id" name="id" placeholder="아이디 입력">
				<input type="submit" name="submit" value="검색하기">
			</form>
			
			<form class="signUp" action="update_user.do" method="post">
				<ul>
					<li>
					...
					<li>
						<label for="passwd"><span>비밀번호</span>
							<input type="password" id="passwd" name="passwd" value="${user.getPasswd()}">
						</label>
					</li>
					<li>
					...
					<li>
						<label for="ssn"><span>주민번호</span>
							<input type="text" id="ssn" name="ssn" value="${user.getSsn()}">
						</label>
					</li>
					<li>
					...
					<li>
						<label for="addr1"><span>주소</span>
							<input type="text" id="addr" name="addr" value="${user.getAddr()}">
						</label>
					</li>
				</ul>
				<div class="center"><input type="submit" name="submit" value="수정하기"/></div>
			</form>
		</div>
		<div id="footer">
